...
class EditBanner:
    ...
    def toggle_repo_is_private_icon(file_path, is_private, remove_if_public=False):
        #
        ...
        PRIVATE_SVG = '''<svg class="repo-header-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" version="1.1" width="16" height="16">
              <path fill-rule="evenodd" d="M240-80q-33 0-56.5-23.5T160-160v-400q0-33 23.5-56.5T240-640h40v-80q0-83 58.5-141.5T480-920q83 0 141.5 58.5T680-720v80h40q33 0 56.5 23.5T800-560v400q0 33-23.5 56.5T720-80H240Zm0-80h480v-400H240v400Zm296.5-143.5Q560-327 560-360t-23.5-56.5Q513-440 480-440t-56.5 23.5Q400-393 400-360t23.5 56.5Q447-280 480-280t56.5-23.5ZM360-640h240v-80q0-50-35-85t-85-35q-50 0-85 35t-35 85v80ZM240-160v-400 400Z"/>
            </svg>'''

        PUBLIC_SVG = '''<svg class="repo-header-icon" xmlns="http://www.w3.org/2000/svg" x="0" y="-13" viewBox="0 0 16 16" version="1.1" width="16" height="16">
              <path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"/>
            </svg>'''

        regex_pattern = r'<svg class="repo-header-icon"[\s\S]*?</svg>'
        replacement = PRIVATE_SVG if is_private else PUBLIC_SVG

        EditBanner.file_replace_content(file_path, regex_pattern, replacement)

        if not is_private and remove_if_public:
