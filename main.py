...
EditBanner.change_recent_repo_name(banner_recent_repo, recent_repo['nameWithOwner'])
...
EditBanner.change_recent_repo_commit_count(banner_recent_repo, recent_repo['commitCount'])
